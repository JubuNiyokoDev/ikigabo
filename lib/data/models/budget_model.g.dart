...
BudgetModel _budgetModelDeserialize(
  ...
  final object = BudgetModel(
    ...
    type: _BudgetModeltypeValueEnumMap[reader.readByteOrNull(offsets[19])] ??
        BudgetType.expense,
...
const _BudgetModeltypeEnumValueMap = {
  'expense': 0,
  'income': 1,
  'saving': 2,
};
