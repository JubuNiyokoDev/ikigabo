...
AssetModel _assetModelDeserialize(
  ...
  final object = AssetModel(
    ...
    status: _AssetModelstatusValueEnumMap[reader.readByteOrNull(offsets[17])] ??
        AssetStatus.owned,
    type: _AssetModeltypeValueEnumMap[reader.readByteOrNull(offsets[19])] ??
        AssetType.livestock,
